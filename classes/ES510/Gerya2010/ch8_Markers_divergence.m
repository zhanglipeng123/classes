...
% Define markers
Nxm=(Nx-1)*5; % Marker grid resolution in horizontal direction
Nym=(Ny-1)*5; % Marker grid resolution in vertical direction
...
visstep=50; % Number of steps between visualization
