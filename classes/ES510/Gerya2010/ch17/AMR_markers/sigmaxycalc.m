% Function epsilonxy()
% This function compose EPSILONxy, SIGMAxy for specific node
% Function return EPSILONxy, SIGMAxy
function[exy1,sxy1]=sigmaxycalc(S,ni,nodx,nody,nodcel,nodeta,celnod,celvar,celres,bupper,blower,bleft,bright,g)
