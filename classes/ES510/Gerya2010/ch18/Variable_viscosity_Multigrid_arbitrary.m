...
% Viscosity_restriction.m
% Stokes_Continuity_viscous_smoother.m,
% Stokes_Continuity_viscous_restriction.m,
% Stokes_Continuity_prolongation.m;
% resolution between multigrid levels changes in an arbitrary way
% 
...
for niter=1:1:inum;
    ...
    for k=1:1:levelnum;
        ...
        switch k
            ...
            [vx1,resx1,vy1,resy1,pr1,resc1]=Stokes_Continuity_viscous_smoother(prfirst,etas1,etan1,iternum(k),krelaxs,krelaxc,xnum(k),ynum(k),xstp(k),ystp(k),RX1,vx1,RY1,vy1,RC1,pr1);
...
%     colorbar;
    ...
    % Add cycle counter
    etannn=etannn+1;
    if(etannn>etacyc && (etamaxcur<etamax || etamincur>etamin))
        % Reset counter
        etannn=1;
