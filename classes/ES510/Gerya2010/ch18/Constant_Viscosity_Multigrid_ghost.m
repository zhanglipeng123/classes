...
% with multigrid based on V-cycle, ghost-node-based smoother 
% Stokes_Continuity_smoother_ghost.m and and external functions
...
for niter=1:1:inum;
    ...
    for k=1:1:levelnum;
        ...
        switch k
            ...
            [vx1,resx1,vy1,resy1,pr1,resc1]=Stokes_Continuity_smoother_ghost(prfirst,etas,iternum(k),krelaxs,krelaxc,xnum(k),ynum(k),xstp(k),ystp(k),RX1,vx1,RY1,vy1,RC1,pr1);
            ...
            % Smoothing operation: 
            [vx2,resx2,vy2,resy2,pr2,resc2]=Stokes_Continuity_smoother_ghost(0,etas,iternum(k),krelaxs,krelaxc,xnum(k),ynum(k),xstp(k),ystp(k),RX2,vx2,RY2,vy2,RC2,pr2);
            % Restriction operation: 
            if (levelnum>k)
            ...
            % Smoothing operation: 
            [vx3,resx3,vy3,resy3,pr3,resc3]=Stokes_Continuity_smoother_ghost(0,etas,iternum(k),krelaxs,krelaxc,xnum(k),ynum(k),xstp(k),ystp(k),RX3,vx3,RY3,vy3,RC3,pr3);
            % Restriction operation: 
            if (levelnum>k)
            ...
            % Smoothing operation: 
            [vx4,resx4,vy4,resy4,pr4,resc4]=Stokes_Continuity_smoother_ghost(0,etas,iternum(k),krelaxs,krelaxc,xnum(k),ynum(k),xstp(k),ystp(k),RX4,vx4,RY4,vy4,RC4,pr4);
            % Restriction operation: 
            if (levelnum>k)
            ...
            % Smoothing operation: 
            [vx5,resx5,vy5,resy5,pr5,resc5]=Stokes_Continuity_smoother_ghost(0,etas,iternum(k),krelaxs,krelaxc,xnum(k),ynum(k),xstp(k),ystp(k),RX5,vx5,RY5,vy5,RC5,pr5);
            % Restriction operation: 
            if (levelnum>k)
            ...
            % Smoothing operation: 
            [vx6,resx6,vy6,resy6,pr6,resc6]=Stokes_Continuity_smoother_ghost(0,etas,iternum(k),krelaxs,krelaxc,xnum(k),ynum(k),xstp(k),ystp(k),RX6,vx6,RY6,vy6,RC6,pr6);
            % Restriction operation: 
            if (levelnum>k)
            ...
            % Smoothing operation: 
            [vx7,resx7,vy7,resy7,pr7,resc7]=Stokes_Continuity_smoother_ghost(0,etas,iternum(k),krelaxs,krelaxc,xnum(k),ynum(k),xstp(k),ystp(k),RX7,vx7,RY7,vy7,RC7,pr7);
            % Restriction operation: 
            if (levelnum>k)
            ...
            % Smoothing operation: 
            [vx8,resx8,vy8,resy8,pr8,resc8]=Stokes_Continuity_smoother_ghost(0,etas,iternum(k),krelaxs,krelaxc,xnum(k),ynum(k),xstp(k),ystp(k),RX8,vx8,RY8,vy8,RC8,pr8);
