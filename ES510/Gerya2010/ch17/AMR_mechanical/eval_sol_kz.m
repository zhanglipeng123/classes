function sol = eval_sol_kz( x, z )
	...
	B     = 6.9; % viscosity parameter must be non-zero 
	km    = 1.6*M_PI; % solution valid for km not zero -- should get trivial solution if km=0 
	n     = 3; % solution valid for n not zero 
	sigma = 1.0;
	%************************************************************************%
	%************************************************************************%
	kn = 3*M_PI;
