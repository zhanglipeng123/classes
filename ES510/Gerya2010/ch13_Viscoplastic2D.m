...
visstep=20; % Periodicity of visualization
...
% Mechanical Solution
% Compute viscosity for pressure nodes
for i=2:1:Ny
    for j=2:1:Nx
...
% Visualise results
if(timestep>=40 && fix(timestep/visstep)*visstep==timestep)
...
plot(40:timestep,(YIELDERR(40:timestep)),'k');
