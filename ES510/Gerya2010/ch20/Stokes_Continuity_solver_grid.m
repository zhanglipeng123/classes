% Function Stokes_Continuity_solver_grid()
...
function[vx,resx,vy,resy,pr,resc]=Stokes_Continuity_solver_grid(prfirst,etas,etan,xnum,ynum,gridx,gridy,RX,RY,RC,bleft,bright,btop,bbottom)
% 
